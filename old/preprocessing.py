...
def clean_text(text):
    ...
    cleaned = textacy.preprocess.preprocess_text(cleaned, fix_unicode=True, lowercase=False, no_urls=True, no_emails=True, no_phone_numbers=True, no_numbers=True, no_currency_symbols=True, no_contractions=True, no_accents=True)
