'''
    Implementation the Bidirectional Recurrent Neural Network model with Gated Recurrent Unit (GRU) using CuDNNGRU
'''
#Import Libraries
import tensorflow as tf
from tensorflow.keras.layers import Embedding, CuDNNGRU, Bidirectional
...
class Bidirectional_RNN_GRU_baseline(KERAS_baseline):
    '''
